...
- Any file under `schemas/`, `configurations/capabilities/`,
  `configurations/domains/`, `configurations/requirement-groups/`,
  or `tools/validate.py` → **minor** (`0.MINOR+1.0`).
...
`python3 tools/check_release_notes.py --base "$BASE_SHA" --head "$GITHUB_SHA"`
