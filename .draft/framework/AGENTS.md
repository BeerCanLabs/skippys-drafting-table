...
1. Read [docs/draftsman.md](docs/draftsman.md).
...
3. Use [schemas/](schemas/) as the authoritative object
   contract.
4. Use [configurations/](configurations/) as the
...
defined in [docs/draftsman.md](docs/draftsman.md).
...
`configurations/`, or other framework files as a substitute for a
...
- If validation reports missing, malformed, duplicate, or legacy object
  identity, use the explicit `tools/repair_uids.py` command that the
  validator prints.
