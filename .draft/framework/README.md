...
browser/      # Static browser shell, CSS, JavaScript, and theme assets
configurations/
...
The effective model is resolved by reading `.draft/configurations/`
...
- [Draftsman instructions for AI](docs/draftsman.md)
- [Draftsman setup mode](docs/setup-mode.md)
- [Draftsman AI guidance](docs/draftsman-ai-configuration.md)
- [Engineering onboarding tutorial](docs/engineering-onboarding.md)
- [Shared Services onboarding tutorial](docs/shared-services-onboarding.md)
- [Draft Admins onboarding tutorial](docs/draft-admins-onboarding.md)
- [Company vocabulary](docs/company-vocabulary.md)
- [DRAFT object types](docs/object-types.md)
- [YAML schema reference](docs/yaml-schema-reference.md)
- [Naming conventions](docs/naming-conventions.md)
- [How to add objects](docs/how-to-add-objects.md)
- [Workspace model](docs/workspaces.md)
- [Authoring templates](templates/)

### Deployable Architecture Content

- [Deployable objects](docs/standards.md)
- [Delivery models](docs/delivery-models.md)
- [ProductComponent schema](schemas/product-component.schema.yaml)
- [ReferenceArchitectures](docs/reference-architectures.md)
- [SoftwareDeploymentPatterns](docs/software-deployment-patterns.md)

### Supporting Model Objects

- [TechnologyComponents](docs/technology-components.md)
- [DecisionRecords](docs/decision-records.md)
- [DraftingSessions](docs/drafting-sessions.md)
- [Capabilities](docs/capabilities.md)

### Extensible Framework Content

- [RequirementGroups](docs/requirement-groups.md)
- [RequirementGroups and Compliance](docs/security-and-compliance-controls.md)
...
```bash
python3 tools/validate.py --workspace /path/to/company-draft-workspace
```
...
JavaScript, and default theme assets are copied from `browser/`.
The same generator renders `docs/user-manual.md` to
