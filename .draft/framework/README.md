...
4. **Local Validation**: Engineers validate architecture locally using `python3 .draft/tools/validate.py --workspace .`.
...
- [Shared Services composition spec](docs/SHARED_SERVICE_COMPOSITION_SPEC.md)
- [Composition roadmap](docs/COMPOSITION_ROADMAP.md)
